...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[1.8rem] border-[3px] border-border bg-card text-card-foreground shadow-[10px_10px_0_hsl(var(--border))]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-xl font-semibold leading-none tracking-tight text-foreground md:text-2xl",
      className
    )}
    {...props}
  />
